...
int mvg_buckets_compare(const void* p_f1, const void* p_f2)
{
    ...
    size_t
        bucket1x
        = mvg_scale * f1->x / mvg_bucket_size,
    ...
    int* matches)
{
    ...
    for (size_t i = 0; i < count1; i++) {
        ...
        for (size_t j = 0; j < buckets2_x * buckets2_y; j++) {
            ...
            const int
                bucket_x
                = (j % buckets2_x) * bucket_size + bucket_size / 2,
