...
struct UI_State {
    ...
    GUI_Panel
        *window,
        *pane, *pane_tools, *div_tools, *div_glview,
    ...
    GUI_Panel
        *root_panel,
        *top, *side, *gl, *side_top, *side_bottom,
        *side_top_last, *tabs;
    ...
    // keyboard
    Uint8* keys;
    std::map<int, bool> key_state; // pointer to array containing keys' state info (supplied by SDL)
